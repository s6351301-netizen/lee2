...
(20, '持有', '臺中市', '大甲區', '3652', '義水段', '0930', '890221', 40.73, '城鄉發展地區第一類', '住宅區', '祭祀公業:100.00%'),
...
CREATE TABLE `land_price` (
  ...
  `record_date` varchar(7) NOT NULL COMMENT '公告年月2026-01',
...
(1, '2026-01', '義水段', '0995-0000', 24398.00, 3049.00, 8278.29),
...
(33, '2026-01', '義水段', '1035-0000', 22613.00, 2802.00, 1657.81),
...
(65, '2026-01', '義水段', '1040-0000', 21200.00, 2600.00, 458.55),
...
(97, '2026-01', '水美東段', '0565-0000', 2000.00, 260.00, 9762.09),
...
(104, '2026-01', '水美東段', '0191-0000', 4300.00, 540.00, 307.71),
...
(111, '2026-01', '水美東段', '0192-0000', 4300.00, 540.00, 306.28),
...
(118, '2026-01', '水美東段', '0193-0000', 2000.00, 260.00, 2919.64),
...
(125, '2026-01', '水美東段', '0194-0000', 2000.00, 260.00, 165.85),
...
(132, '2026-01', '水美東段', '0195-0000', 2000.00, 260.00, 251.59),
...
(331, '2026-01', '義水段', '0911-0000', 24000.00, 3000.00, 277.96),
...
(363, '2026-01', '義水段', '0930-0000', 24000.00, 3000.00, 40.73),
...
(395, '2026-01', '義水段', '0934-0000', 25002.00, 3123.00, 3600.59),
...
(427, '2026-01', '義水段', '0979-0000', 24000.00, 3000.00, 3.33),
...
(459, '2026-01', '義水段', '0980-0000', 24000.00, 3000.00, 75.70),
...
(491, '2026-01', '義水段', '0984-0000', 30013.00, 3740.00, 291.97),
...
(523, '2026-01', '義水段', '0987-0000', 27029.00, 3373.00, 1654.97),
...
(555, '2026-01', '義水段', '0989-0000', 24000.00, 3000.00, 211.57),
...
(587, '2026-01', '義水段', '0855-0000', 22500.00, 2900.00, 12.73),
...
(619, '2026-01', '義水段', '0861-0000', 22767.00, 2930.00, 1285.77),
...
--
ALTER TABLE `land_price`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '自動遞增主鍵', AUTO_INCREMENT=651;
