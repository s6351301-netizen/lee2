...
(1, '李明輝', 'OLD001', '1', '男', 'user1@gmail.com', '$2y$10$j6dxP3mDJVDEQ13vXKRXn.32M.1kUTgaTqnM3HwgJhAaOStt0rDkS', 'admin', '2026-04-12 02:23:14', '1', NULL, '常參與春季祭祖', '', '2026-06-08 18:28:50', '2026-06-14 10:55:36'),
(2, '李美麗', 'OLD002', '2', '女', 'may@gmail.com', '$2y$10$j6dxP3mDJVDEQ13vXKRXn.32M.1kUTgaTqnM3HwgJhAaOStt0rDkS', 'admin', '2026-11-05 06:15:22', '1', NULL, '民國112年除籍，家屬已辦理過戶', '', '2026-06-08 18:28:50', '2026-06-14 08:44:47'),
...
(7, '7', 'OLD007', '李美玲', '女', 'user7@gmail.com', '$2y$10$j6dxP3mDJVDEQ13vXKRXn.32M.1kUTgaTqnM3HwgJhAaOStt0rDkS', 'admin', '2026-03-14 07:25:19', '1', '2026-10-22', '出境國外未歸，狀態待確認', '', '2026-06-08 18:28:50', NULL),
...
(1, '2021-04-12', 'OLD001', '李明輝', 7, 29, 3, '1', '男', 'A123456789', '1975-03-12', '台北市萬華區', '大學', '電子業專案經理', '台北市中正區重慶南路一段10號', '100-005', '0912-345678', '02-23456789', '02-87654321', 'minghui.lee@gmail.com', '李建國', '正常派下員', '存', 1, '常參與春季祭祖\r\n生存狀態(亡)、派下權(無), 派下員狀態, 狀態, 2026-06-14 11:56:02 修改\r\n生存狀態(存)、派下權(有), 派下員狀態, 2026-06-14 11:56:28 修改\r\n', '2026-06-14 11:56:28', '李明輝 1'),
(2, '2020-03-15', 'OLD002', '李美麗', 5, 30, 1, '2', '女', 'F201234567', '1932-08-25', '新北市', '高中', '家管(退休)', '新北市板橋區文化路二段50號', '220-413', '0921-987654', '02-29512345', '', 'meili.lee@yahoo.com.tw', '', '權利停權中', '存', 1, '民國112年除籍，家屬已辦理過戶\r\n生存狀態, 狀態, 2026-06-14 08:44:47 修改\r\n', '2026-06-14 08:44:47', '2 李美麗'),
...
(6, '2020-02-11', 'OLD006', '6', 6, 29, 3, '李文雄', '男', 'H100223344', '1925-01-22', '桃園市', '初中', '農業(退休)', '桃園市桃園區中正路300號', '330-001', '0911-333444', '03-3322111', NULL, 'wenxiong@yahoo.com.tw', NULL, '喪失權利', '亡', 0, '派下權已由長子繼承', NULL, NULL),
(7, '2021-11-05', 'OLD007', '7', 10, 27, 3, '李美玲', '女', 'O221144332', '1983-04-17', '新竹市', '碩士', '竹科外商工程師', '新竹市東區光復路二段101號', '300-044', '0972-666777', '03-5712233', NULL, 'meiling.l@techcorp.com', '李志強', '正常派下員', '亡', 0, '出境國外未歸，狀態待確認', NULL, NULL),
...
--
ALTER TABLE `files`
  MODIFY `file_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '檔案編號', AUTO_INCREMENT=91;
