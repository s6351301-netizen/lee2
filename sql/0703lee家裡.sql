...
--
-- 資料表結構 `ancestor_worship`
--

CREATE TABLE `ancestor_worship` (
  `worship_id` int(11) NOT NULL COMMENT '報名ID',
  `member_id` int(11) DEFAULT NULL COMMENT '會員id',
  `new_member` int(11) DEFAULT NULL COMMENT '會員編號',
  `name` varchar(50) DEFAULT NULL COMMENT '姓名',
  `attendance_date` date DEFAULT NULL COMMENT '祭祖日(西元)',
  `attendance_date_solar` date DEFAULT NULL COMMENT '祭祖日(國曆)',
  `attendance_date_lunar` varchar(20) DEFAULT NULL COMMENT '祭祖日(農曆)',
  `expected_attendance` varchar(10) DEFAULT NULL COMMENT '預計出席(出席/代理)',
  `actual_attendance` varchar(10) DEFAULT NULL COMMENT '實際出席(本人/代理/無出席)',
  `companion_info` varchar(100) DEFAULT NULL COMMENT '攜伴內容(太太和小孩)',
  `meat_count` int(11) DEFAULT NULL COMMENT '葷食數量',
  `veg_count` int(11) DEFAULT NULL COMMENT '素食數量',
  `total_people` int(11) DEFAULT NULL COMMENT '總人數',
  `proxy_member_id` int(11) DEFAULT NULL COMMENT '代理人ID',
  `proxy_new_member` int(11) DEFAULT NULL COMMENT '代理人會員編號',
  `proxy_member_name` varchar(50) DEFAULT NULL COMMENT '代理人姓名',
  ...
  `updater_name-id` varchar(50) DEFAULT NULL COMMENT '更新者id',
  `updater_name` varchar(50) DEFAULT NULL COMMENT '更新者姓名',
  `remark` text DEFAULT NULL COMMENT '備註'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='祭祖活動';
...
--
-- 資料表結構 `ethnic_property`
--

CREATE TABLE `ethnic_property` (
  `id` int(11) NOT NULL COMMENT '流水號',
  `status` varchar(10) DEFAULT NULL COMMENT '狀態(已賣/持有)',
  `city` varchar(50) DEFAULT NULL COMMENT '縣市',
  `district` varchar(50) DEFAULT NULL COMMENT '鄉鎮市區',
  `section_code` varchar(50) DEFAULT NULL COMMENT '段小段代碼',
  `section_name` varchar(50) DEFAULT NULL COMMENT '段小段',
  `land_number` varchar(50) DEFAULT NULL COMMENT '地號',
  `register_date` varchar(20) DEFAULT NULL COMMENT '登記日期',
  `area` decimal(10,2) DEFAULT NULL COMMENT '面積',
  `zoning` varchar(100) DEFAULT NULL COMMENT '使用分區',
  `land_use` varchar(100) DEFAULT NULL COMMENT '使用地類別',
  `owner_type` text DEFAULT NULL COMMENT '土地權利人類別'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='族產資料表';

--
-- 傾印資料表的資料 `ethnic_property`
--

INSERT INTO `ethnic_property` (`id`, `status`, `city`, `district`, `section_code`, `section_name`, `land_number`, `register_date`, `area`, `zoning`, `land_use`, `owner_type`) VALUES
(1, '已賣', '臺中市', '大甲區', '3652', '義水段', '0855-0000', '840519', 12.73, '城鄉發展地區第一類', '兒童遊樂場用地', '本國人:100.00%'),
(2, '已賣', '臺中市', '大甲區', '3652', '義水段', '0856-0000', '840519', 40.89, '城鄉發展地區第一類', '道路用地', '本國人:100.00%'),
(3, '已賣', '臺中市', '大甲區', '3652', '義水段', '0861-0000', '1100126', 1285.77, '城鄉發展地區第一類', '住宅區', '本國私法人:100.00%'),
(4, '已賣', '臺中市', '大甲區', '3652', '義水段', '0865-0000', '1081224', 57.35, '城鄉發展地區第一類', '道路用地', '本國人:100.00%'),
(5, '已賣', '臺中市', '大甲區', '3652', '義水段', '0868-0000', '840519', 39.37, '城鄉發展地區第一類', '道路用地', '本國人:100.00%'),
(6, '已賣', '臺中市', '大甲區', '3652', '義水段', '0869-0000', '840519', 29.24, '城鄉發展地區第一類', '市場用地', '本國人:100.00%'),
(7, '持有', '臺中市', '外埔區', '4034', '水美東段', '0565-0000', '1091101', 9762.09, '特定農業區', '農牧用地', '祭祀公業:100.00%'),
(8, '持有', '臺中市', '外埔區', '4031', '水美南段', '0191-0000', '1061101', 2648.35, '山坡地保育區', '農牧用地', '祭祀公業:100.00%'),
(9, '持有', '臺中市', '外埔區', '4031', '水美南段', '0192-0000', '1061101', 344.44, '山坡地保育區', '墳墓用地', '祭祀公業:100.00%'),
(10, '持有', '臺中市', '外埔區', '4031', '水美南段', '0193-0000', '1061101', 1531.99, '山坡地保育區', '農牧用地', '祭祀公業:100.00%'),
(11, '持有', '臺中市', '外埔區', '4031', '水美南段', '0194-0000', '1061101', 8550.87, '山坡地保育區', '農牧用地', '祭祀公業:100.00%'),
(12, '持有', '臺中市', '外埔區', '4031', '水美南段', '0195-0000', '1061101', 2608.83, '山坡地保育區', '農牧用地', '祭祀公業:100.00%'),
(13, '持有', '臺中市', '大甲區', '3652', '義水段', '0176-0000', '840519', 930.01, '城鄉發展地區第一類', '住宅區', '祭祀公業:100.00%'),
(14, '持有', '臺中市', '大甲區', '3652', '義水段', '0385-0000', '840519', 100.58, '城鄉發展地區第一類', '道路用地', '祭祀公業:100.00%'),
(15, '持有', '臺中市', '大甲區', '3652', '義水段', '0864-0000', '1080306', 1015.12, '城鄉發展地區第一類', '住宅區', '祭祀公業:100.00%'),
(16, '持有', '臺中市', '大甲區', '3652', '義水段', '0871-0000', '840913', 173.33, '城鄉發展地區第一類', '市場用地', '祭祀公業:100.00%'),
(17, '持有', '臺中市', '大甲區', '3652', '義水段', '0876-0000', '1080812', 6.48, '城鄉發展地區第一類', '住宅區', '祭祀公業:100.00%'),
(18, '持有', '臺中市', '大甲區', '3652', '義水段', '0909-0000', '840913', 537.47, '城鄉發展地區第一類', '住宅區', '祭祀公業:100.00%'),
(19, '持有', '臺中市', '大甲區', '3652', '義水段', '0911-0000', '840913', 277.96, '城鄉發展地區第一類', '道路用地', '祭祀公業:100.00%'),
(20, '持有', '臺中市', '大甲區', '3652', '義水段', '0930-0000', '890221', 40.73, '城鄉發展地區第一類', '住宅區', '祭祀公業:100.00%'),
(21, '持有', '臺中市', '大甲區', '3652', '義水段', '0934-0000', '890221', 3600.59, '城鄉發展地區第一類', '住宅區', '祭祀公業:100.00%'),
(22, '持有', '臺中市', '大甲區', '3652', '義水段', '0979-0000', '890221', 3.33, '城鄉發展地區第一類', '住宅區', '祭祀公業:100.00%'),
(23, '持有', '臺中市', '大甲區', '3652', '義水段', '0980-0000', '890221', 75.70, '城鄉發展地區第一類', '道路用地', '祭祀公業:100.00%'),
(24, '持有', '臺中市', '大甲區', '3652', '義水段', '0984-0000', '840913', 291.97, '城鄉發展地區第一類', '住宅區', '祭祀公業:100.00%'),
(25, '持有', '臺中市', '大甲區', '3652', '義水段', '0987-0000', '840913', 1654.97, '城鄉發展地區第一類', '住宅區', '祭祀公業:100.00%'),
(26, '持有', '臺中市', '大甲區', '3652', '義水段', '0989-0000', '840523', 211.57, '城鄉發展地區第一類', '住宅區', '祭祀公業:100.00%'),
(27, '持有', '臺中市', '大甲區', '3652', '義水段', '0995-0000', '840512', 8278.29, '城鄉發展地區第一類', '住宅區', '國有:1.65%\n本國人:95.48%\n祭祀公業:2.88%'),
(28, '持有', '臺中市', '大甲區', '3652', '義水段', '1035-0000', '840512', 1657.81, '城鄉發展地區第一類', '綠地用地', '省市有:1.82%\n國有:1.28%\n本國人:94.02%\n祭祀公業:2.88%'),
(29, '持有', '臺中市', '大甲區', '3652', '義水段', '1040-0000', '840512', 458.55, '城鄉發展地區第一類', '乙種工業區', '國有:1.81%\n本國人:95.32%\n祭祀公業:2.88%');
...
CREATE TABLE `land_price` (
  `id` int(11) NOT NULL COMMENT '自動遞增主鍵',
  `record_date` varchar(7) NOT NULL COMMENT '公告年月(如2026-01)',
  `section_name` varchar(50) NOT NULL COMMENT '段名小段名',
  `land_number` varchar(20) NOT NULL COMMENT '地號',
  `posted_land_value` decimal(12,2) DEFAULT NULL COMMENT '公告土地現值 (元/平方公尺)',
  `declared_land_value` decimal(12,2) DEFAULT NULL COMMENT '公告地價 (元/平方公尺)',
  `land_area` decimal(12,2) DEFAULT NULL COMMENT '面積 (平方公尺)'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='土地公告現值與公告地價資料表';

--
-- 傾印資料表的資料 `land_price`
--

INSERT INTO `land_price` (`id`, `record_date`, `section_name`, `land_number`, `posted_land_value`, `declared_land_value`, `land_area`) VALUES
(1, '2027-01', '義水段', '0995-0000', 24398.00, 3049.00, 8278.29),
(2, '2025-01', '義水段', '0995-0000', 24098.00, 2949.00, 8278.29),
(3, '2024-01', '義水段', '0995-0000', 23592.00, 2949.00, 8278.29),
(4, '2023-01', '義水段', '0995-0000', 23286.00, 2949.00, 8278.29),
(5, '2022-01', '義水段', '0995-0000', 23286.00, 2949.00, 8278.29),
(6, '2021-01', '義水段', '0995-0000', 23110.00, 2940.00, 8278.29),
(7, '2020-01', '義水段', '0995-0000', 23015.00, 2940.00, 8278.29),
(8, '2019-01', '義水段', '0995-0000', 23015.00, 3345.00, 8278.29),
(9, '2018-01', '義水段', '0995-0000', 22825.00, 3345.00, 8278.29),
(10, '2017-01', '義水段', '0995-0000', 22825.00, 3545.00, 8278.29),
(11, '2016-01', '義水段', '0995-0000', 22825.00, 3545.00, 8278.29),
(12, '2015-01', '義水段', '0995-0000', 21400.00, 2940.00, 8278.29),
(13, '2014-01', '義水段', '0995-0000', 19850.00, 2940.00, 8278.29),
(14, '2013-01', '義水段', '0995-0000', 18100.00, 2940.00, 8278.29),
(15, '2012-01', '義水段', '0995-0000', 17600.00, 2835.00, 8278.29),
(16, '2011-01', '義水段', '0995-0000', 16600.00, 2835.00, 8278.29),
(17, '2010-01', '義水段', '0995-0000', 16575.00, 2835.00, 8278.29),
(18, '2009-01', '義水段', '0995-0000', 16575.00, 2835.00, 8278.29),
(19, '2008-01', '義水段', '0995-0000', 16575.00, 2835.00, 8278.29),
(20, '2007-01', '義水段', '0995-0000', 16575.00, 2835.00, 8278.29),
(21, '2006-01', '義水段', '0995-0000', 16100.00, 2835.00, 8278.29),
(22, '2005-01', '義水段', '0995-0000', 14200.00, 2835.00, 8278.29),
(23, '2004-01', '義水段', '0995-0000', 14200.00, 2835.00, 8278.29),
(24, '2003-01', '義水段', '0995-0000', 14200.00, 2835.00, 8278.29),
(25, '2002-07', '義水段', '0995-0000', 14200.00, 2835.00, NULL),
(26, '2001-07', '義水段', '0995-0000', 14200.00, 2835.00, NULL),
(27, '2000-07', '義水段', '0995-0000', 14200.00, 2835.00, NULL),
(28, '1999-07', '義水段', '0995-0000', 14200.00, 2530.00, NULL),
(29, '1998-07', '義水段', '0995-0000', 14200.00, 2530.00, NULL),
(30, '1997-07', '義水段', '0995-0000', 13250.00, 2530.00, NULL),
(31, '1996-07', '義水段', '0995-0000', 13250.00, NULL, NULL),
(32, '1995-07', '義水段', '0995-0000', 13000.00, NULL, NULL),
(33, '2027-01', '義水段', '1035-0000', 22613.00, 2802.00, 1657.81),
(34, '2025-01', '義水段', '1035-0000', 22462.00, 2751.00, 1657.81),
(35, '2024-01', '義水段', '1035-0000', 21714.00, 2751.00, 1657.81),
(36, '2023-01', '義水段', '1035-0000', 21464.00, 2702.00, 1657.81),
(37, '2022-01', '義水段', '1035-0000', 21464.00, 2702.00, 1657.81),
(38, '2021-01', '義水段', '1035-0000', 21364.00, 2700.00, 1657.81),
(39, '2020-01', '義水段', '1035-0000', 21313.00, 2700.00, 1657.81),
(40, '2019-01', '義水段', '1035-0000', 21363.00, 2800.00, 1657.81),
(41, '2018-01', '義水段', '1035-0000', 21262.00, 2800.00, 1657.81),
(42, '2017-01', '義水段', '1035-0000', 21262.00, 2800.00, 1657.81),
(43, '2016-01', '義水段', '1035-0000', 21262.00, 2800.00, 1657.81),
(44, '2015-01', '義水段', '1035-0000', 20009.00, 2600.00, 1657.81),
(45, '2014-01', '義水段', '1035-0000', 18757.00, 2600.00, 1657.81),
(46, '2013-01', '義水段', '1035-0000', 16025.00, 2600.00, 1657.81),
(47, '2012-01', '義水段', '1035-0000', 15771.00, 2500.00, 1657.81),
(48, '2011-01', '義水段', '1035-0000', 15018.00, 2500.00, 1657.81),
(49, '2010-01', '義水段', '1035-0000', 15018.00, 2500.00, 1657.81),
(50, '2009-01', '義水段', '1035-0000', 15018.00, 2500.00, 1657.81),
(51, '2008-01', '義水段', '1035-0000', 15018.00, 2500.00, 1657.81),
(52, '2007-01', '義水段', '1035-0000', 15018.00, 2500.00, 1657.81),
(53, '2006-01', '義水段', '1035-0000', 14518.00, 2454.00, 1657.81),
(54, '2005-01', '義水段', '1035-0000', 12518.00, 2454.00, 1657.81),
(55, '2004-01', '義水段', '1035-0000', 12518.00, 2454.00, 1657.81),
(56, '2003-01', '義水段', '1035-0000', 12500.00, 2450.00, 1657.81),
(57, '2002-07', '義水段', '1035-0000', 12500.00, 2450.00, NULL),
(58, '2001-07', '義水段', '1035-0000', 12500.00, 2450.00, NULL),
(59, '2000-07', '義水段', '1035-0000', 12500.00, 2450.00, NULL),
(60, '1999-07', '義水段', '1035-0000', 12500.00, 2200.00, NULL),
(61, '1998-07', '義水段', '1035-0000', 12500.00, 2200.00, NULL),
(62, '1997-07', '義水段', '1035-0000', 11500.00, 2200.00, NULL),
(63, '1996-07', '義水段', '1035-0000', 11500.00, NULL, NULL),
(64, '1995-07', '義水段', '1035-0000', 11500.00, NULL, NULL),
(65, '2027-01', '義水段', '1040-0000', 21200.00, 2600.00, 458.55),
(66, '2025-01', '義水段', '1040-0000', 21200.00, 2600.00, 458.55),
(67, '2024-01', '義水段', '1040-0000', 20200.00, 2600.00, 458.55),
(68, '2023-01', '義水段', '1040-0000', 20000.00, 2500.00, 458.55),
(69, '2022-01', '義水段', '1040-0000', 20000.00, 2500.00, 458.55),
(70, '2021-01', '義水段', '1040-0000', 19900.00, 2500.00, 458.55),
(71, '2020-01', '義水段', '1040-0000', 19900.00, 2500.00, 458.55),
(72, '2019-01', '義水段', '1040-0000', 20000.00, 2700.00, 458.55),
(73, '2018-01', '義水段', '1040-0000', 20000.00, 2700.00, 458.55),
(74, '2017-01', '義水段', '1040-0000', 20000.00, 2700.00, 458.55),
(75, '2016-01', '義水段', '1040-0000', 20000.00, 2700.00, 458.55),
(76, '2015-01', '義水段', '1040-0000', 19000.00, 2200.00, 458.55),
(77, '2014-01', '義水段', '1040-0000', 18000.00, 2200.00, 458.55),
(78, '2013-01', '義水段', '1040-0000', 14000.00, 2200.00, 458.55),
(79, '2012-01', '義水段', '1040-0000', 14000.00, 2100.00, 458.55),
(80, '2011-01', '義水段', '1040-0000', 13500.00, 2100.00, 458.55),
(81, '2010-01', '義水段', '1040-0000', 13500.00, 2100.00, 458.55),
(82, '2009-01', '義水段', '1040-0000', 13500.00, 2100.00, 458.55),
(83, '2008-01', '義水段', '1040-0000', 13500.00, 2100.00, 458.55),
(84, '2007-01', '義水段', '1040-0000', 13500.00, 2100.00, 458.55),
(85, '2006-01', '義水段', '1040-0000', 13000.00, 2100.00, 458.55),
(86, '2005-01', '義水段', '1040-0000', 11000.00, 2100.00, 458.55),
(87, '2004-01', '義水段', '1040-0000', 11000.00, 2100.00, 458.55),
(88, '2003-01', '義水段', '1040-0000', 11000.00, 2100.00, 458.55),
(89, '2002-07', '義水段', '1040-0000', 11000.00, 2100.00, NULL),
(90, '2001-07', '義水段', '1040-0000', 11000.00, 2100.00, NULL),
(91, '2000-07', '義水段', '1040-0000', 11000.00, 2100.00, NULL),
(92, '1999-07', '義水段', '1040-0000', 11000.00, 1900.00, NULL),
(93, '1998-07', '義水段', '1040-0000', 11000.00, 1900.00, NULL),
(94, '1997-07', '義水段', '1040-0000', 10000.00, 1900.00, NULL),
(95, '1996-07', '義水段', '1040-0000', 10000.00, NULL, NULL),
(96, '1995-07', '義水段', '1040-0000', 10000.00, NULL, NULL),
(97, '2027-01', '水美東段', '0565-0000', 2000.00, 260.00, 9762.09),
(98, '2025-01', '水美東段', '0565-0000', 2000.00, 260.00, 9762.09),
(99, '2024-01', '水美東段', '0565-0000', 2000.00, 260.00, 9762.09),
(100, '2023-01', '水美東段', '0565-0000', 2000.00, 260.00, 9762.09),
(101, '2022-01', '水美東段', '0565-0000', 2000.00, 260.00, 9762.09),
(102, '2021-01', '水美東段', '0565-0000', 2000.00, 260.00, 9762.09),
(103, '2020-01', '水美東段', '0565-0000', 2000.00, 260.00, 9762.09),
(104, '2027-01', '水美東段', '0191-0000', 4300.00, 540.00, 307.71),
(105, '2025-01', '水美東段', '0191-0000', 4300.00, 500.00, 307.71),
(106, '2024-01', '水美東段', '0191-0000', 4100.00, 500.00, 307.71),
(107, '2023-01', '水美東段', '0191-0000', 4100.00, 450.00, 307.71),
(108, '2022-01', '水美東段', '0191-0000', 3900.00, 450.00, 307.71),
(109, '2021-01', '水美東段', '0191-0000', 3900.00, 450.00, 307.71),
(110, '2020-01', '水美東段', '0191-0000', 3900.00, 450.00, 307.71),
(111, '2027-01', '水美東段', '0192-0000', 4300.00, 540.00, 306.28),
(112, '2025-01', '水美東段', '0192-0000', 4300.00, 500.00, 306.28),
(113, '2024-01', '水美東段', '0192-0000', 4100.00, 500.00, 306.28),
(114, '2023-01', '水美東段', '0192-0000', 4100.00, 450.00, 306.28),
(115, '2022-01', '水美東段', '0192-0000', 3900.00, 450.00, 306.28),
(116, '2021-01', '水美東段', '0192-0000', 3900.00, 450.00, 306.28),
(117, '2020-01', '水美東段', '0192-0000', 3900.00, 450.00, 306.28),
(118, '2027-01', '水美東段', '0193-0000', 2000.00, 260.00, 2919.64),
(119, '2025-01', '水美東段', '0193-0000', 2000.00, 260.00, 2919.64),
(120, '2024-01', '水美東段', '0193-0000', 2000.00, 260.00, 2919.64),
(121, '2023-01', '水美東段', '0193-0000', 2000.00, 260.00, 2919.64),
(122, '2022-01', '水美東段', '0193-0000', 2000.00, 260.00, 2919.64),
(123, '2021-01', '水美東段', '0193-0000', 2000.00, 260.00, 2919.64),
(124, '2020-01', '水美東段', '0193-0000', 2000.00, 260.00, 2919.64),
(125, '2027-01', '水美東段', '0194-0000', 2000.00, 260.00, 165.85),
(126, '2025-01', '水美東段', '0194-0000', 2000.00, 260.00, 165.85),
(127, '2024-01', '水美東段', '0194-0000', 2000.00, 260.00, 165.85),
(128, '2023-01', '水美東段', '0194-0000', 2000.00, 260.00, 165.85),
(129, '2022-01', '水美東段', '0194-0000', 2000.00, 260.00, 165.85),
(130, '2021-01', '水美東段', '0194-0000', 2000.00, 260.00, 165.85),
(131, '2020-01', '水美東段', '0194-0000', 2000.00, 260.00, 165.85),
(132, '2027-01', '水美東段', '0195-0000', 2000.00, 260.00, 251.59),
(133, '2025-01', '水美東段', '0195-0000', 2000.00, 260.00, 251.59),
(134, '2024-01', '水美東段', '0195-0000', 2000.00, 260.00, 251.59),
(135, '2023-01', '水美東段', '0195-0000', 2000.00, 260.00, 251.59),
(136, '2022-01', '水美東段', '0195-0000', 2000.00, 260.00, 251.59),
(137, '2021-01', '水美東段', '0195-0000', 2000.00, 260.00, 251.59),
(138, '2020-01', '水美東段', '0195-0000', 2000.00, 260.00, 251.59),
(139, '2026-01', '義水段', '0176-0000', 27787.00, 3466.00, 930.01),
(140, '2025-01', '義水段', '0176-0000', 27487.00, 3366.00, 930.01),
(141, '2024-01', '義水段', '0176-0000', 26928.00, 3366.00, 930.01),
(142, '2023-01', '義水段', '0176-0000', 26570.00, 3366.00, 930.01),
(143, '2022-01', '義水段', '0176-0000', 26570.00, 3366.00, 930.01),
(144, '2021-01', '義水段', '0176-0000', 26412.00, 3366.00, 930.01),
(145, '2020-01', '義水段', '0176-0000', 26370.00, 3366.00, 930.01),
(146, '2019-01', '義水段', '0176-0000', 26370.00, 3824.00, 930.01),
(147, '2018-01', '義水段', '0176-0000', 26287.00, 3824.00, 930.01),
(148, '2017-01', '義水段', '0176-0000', 26643.00, 4074.00, 930.01),
(149, '2016-01', '義水段', '0176-0000', 26643.00, 4074.00, 930.01),
(150, '2015-01', '義水段', '0176-0000', 26099.00, 3410.00, 930.01),
(151, '2014-01', '義水段', '0176-0000', 23961.00, 3410.00, 930.01),
(152, '2013-01', '義水段', '0176-0000', 19275.00, 3410.00, 930.01),
(153, '2012-01', '義水段', '0176-0000', 18775.00, 3246.00, 930.01),
(154, '2011-01', '義水段', '0176-0000', 17775.00, 3246.00, 930.01),
(155, '2010-01', '義水段', '0176-0000', 17456.00, 3246.00, 930.01),
(156, '2009-01', '義水段', '0176-0000', 17456.00, 3246.00, 930.01),
(157, '2008-01', '義水段', '0176-0000', 17456.00, 3246.00, 930.01),
(158, '2007-01', '義水段', '0176-0000', 17456.00, 3246.00, 930.01),
(159, '2006-01', '義水段', '0176-0000', 17275.00, 3246.00, 930.01),
(160, '2005-01', '義水段', '0176-0000', 16549.00, 3246.00, 930.01),
(161, '2004-01', '義水段', '0176-0000', 16549.00, 3246.00, 930.01),
(162, '2003-01', '義水段', '0176-0000', 16549.00, 3246.00, 930.01),
(163, '2002-07', '義水段', '0176-0000', 16549.00, 3246.00, NULL),
(164, '2001-07', '義水段', '0176-0000', 16549.00, 3246.00, NULL),
(165, '2000-07', '義水段', '0176-0000', 16549.00, 3246.00, NULL),
(166, '1999-07', '義水段', '0176-0000', 16549.00, 2882.00, NULL),
(167, '1998-07', '義水段', '0176-0000', 16549.00, 2882.00, NULL),
(168, '1997-07', '義水段', '0176-0000', 16187.00, 2882.00, NULL),
(169, '1996-07', '義水段', '0176-0000', 16187.00, NULL, NULL),
(170, '1995-07', '義水段', '0176-0000', 13000.00, NULL, NULL),
(171, '2026-01', '義水段', '0385-0000', 26647.00, 3326.00, 100.58),
(172, '2025-01', '義水段', '0385-0000', 26347.00, 3226.00, 100.58),
(173, '2024-01', '義水段', '0385-0000', 25806.00, 3226.00, 100.58),
(174, '2023-01', '義水段', '0385-0000', 25466.00, 3226.00, 100.58),
(175, '2022-01', '義水段', '0385-0000', 25466.00, 3226.00, 100.58),
(176, '2021-01', '義水段', '0385-0000', 25325.00, 3226.00, 100.58),
(177, '2020-01', '義水段', '0385-0000', 25266.00, 3226.00, 100.58),
(178, '2019-01', '義水段', '0385-0000', 25266.00, 3667.00, 100.58),
(179, '2018-01', '義水段', '0385-0000', 25147.00, 3667.00, 100.58),
(180, '2017-01', '義水段', '0385-0000', 25698.00, 3943.00, 100.58),
(181, '2016-01', '義水段', '0385-0000', 25698.00, 3943.00, 100.58),
(182, '2015-01', '義水段', '0385-0000', 24936.00, 3294.00, 100.58),
(183, '2014-01', '義水段', '0385-0000', 22944.00, 3294.00, 100.58),
(184, '2013-01', '義水段', '0385-0000', 18984.00, 3294.00, 100.58),
(185, '2012-01', '義水段', '0385-0000', 18484.00, 3144.00, 100.58),
(186, '2011-01', '義水段', '0385-0000', 17484.00, 3144.00, 100.58),
(187, '2010-01', '義水段', '0385-0000', 17238.00, 3144.00, 100.58),
(188, '2009-01', '義水段', '0385-0000', 17238.00, 3144.00, 100.58),
(189, '2008-01', '義水段', '0385-0000', 17238.00, 3144.00, 100.58),
(190, '2007-01', '義水段', '0385-0000', 17238.00, 3144.00, 100.58),
(191, '2006-01', '義水段', '0385-0000', 16984.00, 3144.00, 100.58),
(192, '2005-01', '義水段', '0385-0000', 15968.00, 3144.00, 100.58),
(193, '2004-01', '義水段', '0385-0000', 15968.00, 3144.00, 100.58),
(194, '2003-01', '義水段', '0385-0000', 15968.00, 3144.00, 100.58),
(195, '2002-07', '義水段', '0385-0000', 15968.00, 3144.00, NULL),
(196, '2001-07', '義水段', '0385-0000', 15968.00, 3144.00, NULL),
(197, '2000-07', '義水段', '0385-0000', 15968.00, 3144.00, NULL),
(198, '1999-07', '義水段', '0385-0000', 15968.00, 2795.00, NULL),
(199, '1998-07', '義水段', '0385-0000', 15968.00, 2795.00, NULL),
(200, '1997-07', '義水段', '0385-0000', 15460.00, 2795.00, NULL),
(201, '1996-07', '義水段', '0385-0000', 15460.00, NULL, NULL),
(202, '1995-07', '義水段', '0385-0000', 13000.00, NULL, NULL),
(203, '2026-01', '義水段', '0864-0000', 30397.00, 3788.00, 1015.12),
(204, '2025-01', '義水段', '0864-0000', 30098.00, 3688.00, 1015.12),
(205, '2024-01', '義水段', '0864-0000', 29498.00, 3688.00, 1015.12),
(206, '2023-01', '義水段', '0864-0000', 29099.00, 3687.00, 1015.12),
(207, '2022-01', '義水段', '0864-0000', 29098.00, 3687.00, 1015.12),
(208, '2021-01', '義水段', '0864-0000', 28589.00, 3647.00, 1015.12),
(209, '2020-01', '義水段', '0864-0000', 28599.00, 3647.00, 1015.12),
(210, '2019-01', '義水段', '0864-0000', 28615.00, 4135.00, 1015.12),
(211, '2018-01', '義水段', '0864-0000', 28635.00, 4135.00, 1070.20),
(212, '2017-01', '義水段', '0864-0000', 28655.00, 4335.00, 1070.20),
(213, '2016-01', '義水段', '0864-0000', 28655.00, 4335.00, 1070.20),
(214, '2015-01', '義水段', '0864-0000', 28600.00, 3645.00, 1070.20),
(215, '2014-01', '義水段', '0864-0000', 26150.00, 3645.00, 1070.20),
(216, '2013-01', '義水段', '0864-0000', 19800.00, 3645.00, 1070.20),
(217, '2012-01', '義水段', '0864-0000', 19300.00, 3450.00, 1070.20),
(218, '2011-01', '義水段', '0864-0000', 18300.00, 3450.00, 1070.20),
(219, '2010-01', '義水段', '0864-0000', 17800.00, 3450.00, 1070.20),
(220, '2009-01', '義水段', '0864-0000', 17800.00, 3450.00, 1070.20),
(221, '2008-01', '義水段', '0864-0000', 17800.00, 3450.00, 1070.20),
(222, '2007-01', '義水段', '0864-0000', 17800.00, 3450.00, 1070.20),
(223, '2006-01', '義水段', '0864-0000', 17800.00, 3450.00, 1070.20),
(224, '2005-01', '義水段', '0864-0000', 17750.00, 3450.00, 1070.20),
(225, '2004-01', '義水段', '0864-0000', 17750.00, 3450.00, 1070.20),
(226, '2003-01', '義水段', '0864-0000', 17750.00, 3450.00, 1070.20),
(227, '2002-07', '義水段', '0864-0000', 17750.00, 3450.00, NULL),
(228, '2001-07', '義水段', '0864-0000', 17750.00, 3450.00, NULL),
(229, '2000-07', '義水段', '0864-0000', 17750.00, 3450.00, NULL),
(230, '1999-07', '義水段', '0864-0000', 17750.00, 3070.00, NULL),
(231, '1998-07', '義水段', '0864-0000', 17750.00, 3070.00, NULL),
(232, '1997-07', '義水段', '0864-0000', 17750.00, 3070.00, NULL),
(233, '1996-07', '義水段', '0864-0000', 17750.00, NULL, NULL),
(234, '1995-07', '義水段', '0864-0000', 13000.00, NULL, NULL),
(235, '2026-01', '義水段', '0871-0000', 30500.00, 3800.00, 173.33),
(236, '2025-01', '義水段', '0871-0000', 30200.00, 3700.00, 173.33),
(237, '2024-01', '義水段', '0871-0000', 29600.00, 3700.00, 173.33),
(238, '2023-01', '義水段', '0871-0000', 29200.00, 3700.00, 173.33),
(239, '2022-01', '義水段', '0871-0000', 29200.00, 3700.00, 173.33),
(240, '2021-01', '義水段', '0871-0000', 29000.00, 3700.00, 173.33),
(241, '2020-01', '義水段', '0871-0000', 29000.00, 3700.00, 173.33),
(242, '2019-01', '義水段', '0871-0000', 29000.00, 4200.00, 173.33),
(243, '2018-01', '義水段', '0871-0000', 29000.00, 4200.00, 173.33),
(244, '2017-01', '義水段', '0871-0000', 29000.00, 4400.00, 173.33),
(245, '2016-01', '義水段', '0871-0000', 29000.00, 4400.00, 173.33),
(246, '2015-01', '義水段', '0871-0000', 29000.00, 3700.00, 173.33),
(247, '2014-01', '義水段', '0871-0000', 26500.00, 3700.00, 173.33),
(248, '2013-01', '義水段', '0871-0000', 20000.00, 3700.00, 173.33),
(249, '2012-01', '義水段', '0871-0000', 19500.00, 3500.00, 173.33),
(250, '2011-01', '義水段', '0871-0000', 18500.00, 3500.00, 173.33),
(251, '2010-01', '義水段', '0871-0000', 18000.00, 3500.00, 173.33),
(252, '2009-01', '義水段', '0871-0000', 18000.00, 3500.00, 173.33),
(253, '2008-01', '義水段', '0871-0000', 18000.00, 3500.00, 173.33),
(254, '2007-01', '義水段', '0871-0000', 18000.00, 3500.00, 173.33),
(255, '2006-01', '義水段', '0871-0000', 18000.00, 3500.00, 173.33),
(256, '2005-01', '義水段', '0871-0000', 18000.00, 3500.00, 173.33),
(257, '2004-01', '義水段', '0871-0000', 18000.00, 3500.00, 173.33),
(258, '2003-01', '義水段', '0871-0000', 18000.00, 3500.00, 173.33),
(259, '2002-07', '義水段', '0871-0000', 18000.00, 3500.00, NULL),
(260, '2001-07', '義水段', '0871-0000', 18000.00, 3500.00, NULL),
(261, '2000-07', '義水段', '0871-0000', 18000.00, 3500.00, NULL),
(262, '1999-07', '義水段', '0871-0000', 18000.00, 3100.00, NULL),
(263, '1998-07', '義水段', '0871-0000', 18000.00, 3100.00, NULL),
(264, '1997-07', '義水段', '0871-0000', 18000.00, 3100.00, NULL),
(265, '1996-07', '義水段', '0871-0000', 18000.00, NULL, NULL),
(266, '1995-07', '義水段', '0871-0000', 13000.00, NULL, NULL),
(267, '2026-01', '義水段', '0876-0000', 24000.00, 3000.00, 6.48),
(268, '2025-01', '義水段', '0876-0000', 23700.00, 2900.00, 6.48),
(269, '2024-01', '義水段', '0876-0000', 23200.00, 2900.00, 6.48),
(270, '2023-01', '義水段', '0876-0000', 22900.00, 2900.00, 6.48),
(271, '2022-01', '義水段', '0876-0000', 22900.00, 2900.00, 6.48),
(272, '2021-01', '義水段', '0876-0000', 22800.00, 2900.00, 6.48),
(273, '2020-01', '義水段', '0876-0000', 22700.00, 2900.00, 6.48),
(274, '2019-01', '義水段', '0876-0000', 22700.00, 3510.00, 6.48),
(275, '2018-01', '義水段', '0876-0000', 24015.00, 3510.00, 361.68),
(276, '2017-01', '義水段', '0876-0000', 24117.00, 3724.00, 361.68),
(277, '2016-01', '義水段', '0876-0000', 24117.00, 3724.00, 361.68),
(278, '2015-01', '義水段', '0876-0000', 22990.00, 3099.00, 361.68),
(279, '2014-01', '義水段', '0876-0000', 21241.00, 3099.00, 361.68),
(280, '2013-01', '義水段', '0876-0000', 18497.00, 3099.00, 361.68),
(281, '2012-01', '義水段', '0876-0000', 17997.00, 2974.00, 361.68),
(282, '2011-01', '義水段', '0876-0000', 16997.00, 2974.00, 361.68),
(283, '2010-01', '義水段', '0876-0000', 16873.00, 2974.00, 361.68),
(284, '2009-01', '義水段', '0876-0000', 16873.00, 2974.00, 361.68),
(285, '2008-01', '義水段', '0876-0000', 16873.00, 2974.00, 361.68),
(286, '2007-01', '義水段', '0876-0000', 16873.00, 2974.00, 361.68),
(287, '2006-01', '義水段', '0876-0000', 16497.00, 2974.00, 361.68),
(288, '2005-01', '義水段', '0876-0000', 14995.00, 2974.00, 361.68),
(289, '2004-01', '義水段', '0876-0000', 14995.00, 2974.00, 361.68),
(290, '2003-01', '義水段', '0876-0000', 14995.00, 2974.00, 361.68),
(291, '2002-07', '義水段', '0876-0000', 14995.00, 2974.00, NULL),
(292, '2001-07', '義水段', '0876-0000', 14995.00, 2974.00, NULL),
(293, '2000-07', '義水段', '0876-0000', 14995.00, 2974.00, NULL),
(294, '1999-07', '義水段', '0876-0000', 14995.00, 2649.00, NULL),
(295, '1998-07', '義水段', '0876-0000', 14995.00, 2649.00, NULL),
(296, '1997-07', '義水段', '0876-0000', 14244.00, 2649.00, NULL),
(297, '1996-07', '義水段', '0876-0000', 14244.00, NULL, NULL),
(298, '1995-07', '義水段', '0876-0000', 13000.00, NULL, NULL),
(299, '2026-01', '義水段', '0909-0000', 24000.00, 3000.00, 537.47),
(300, '2025-01', '義水段', '0909-0000', 23700.00, 2900.00, 537.47),
(301, '2024-01', '義水段', '0909-0000', 23200.00, 2900.00, 537.47),
(302, '2023-01', '義水段', '0909-0000', 22900.00, 2900.00, 537.47),
(303, '2022-01', '義水段', '0909-0000', 22900.00, 2900.00, 537.47),
(304, '2021-01', '義水段', '0909-0000', 22800.00, 2900.00, 537.47),
(305, '2020-01', '義水段', '0909-0000', 22700.00, 2900.00, 537.47),
(306, '2019-01', '義水段', '0909-0000', 22700.00, 3300.00, 537.47),
(307, '2018-01', '義水段', '0909-0000', 22500.00, 3300.00, 537.47),
(308, '2017-01', '義水段', '0909-0000', 22500.00, 3500.00, 537.47),
(309, '2016-01', '義水段', '0909-0000', 22500.00, 3500.00, 537.47),
(310, '2015-01', '義水段', '0909-0000', 21000.00, 2900.00, 537.47),
(311, '2014-01', '義水段', '0909-0000', 19500.00, 2900.00, 537.47),
(312, '2013-01', '義水段', '0909-0000', 18000.00, 2900.00, 537.47),
(313, '2012-01', '義水段', '0909-0000', 17500.00, 2800.00, 537.47),
(314, '2011-01', '義水段', '0909-0000', 16500.00, 2800.00, 537.47),
(315, '2010-01', '義水段', '0909-0000', 16500.00, 2800.00, 537.47),
(316, '2009-01', '義水段', '0909-0000', 16500.00, 2800.00, 537.47),
(317, '2008-01', '義水段', '0909-0000', 16500.00, 2800.00, 537.47),
(318, '2007-01', '義水段', '0909-0000', 16500.00, 2800.00, 537.47),
(319, '2006-01', '義水段', '0909-0000', 16000.00, 2800.00, 537.47),
(320, '2005-01', '義水段', '0909-0000', 14000.00, 2800.00, 537.47),
(321, '2004-01', '義水段', '0909-0000', 14000.00, 2800.00, 537.47),
(322, '2003-01', '義水段', '0909-0000', 14000.00, 2800.00, 537.47),
(323, '2002-07', '義水段', '0909-0000', 14000.00, 2800.00, NULL),
(324, '2001-07', '義水段', '0909-0000', 14000.00, 2800.00, NULL),
(325, '2000-07', '義水段', '0909-0000', 14000.00, 2800.00, NULL),
(326, '1999-07', '義水段', '0909-0000', 14000.00, 2500.00, NULL),
(327, '1998-07', '義水段', '0909-0000', 14000.00, 2500.00, NULL),
(328, '1997-07', '義水段', '0909-0000', 13000.00, 2500.00, NULL),
(329, '1996-07', '義水段', '0909-0000', 13000.00, NULL, NULL),
(330, '1995-07', '義水段', '0909-0000', 13000.00, NULL, NULL),
(331, '2027-01', '義水段', '0911-0000', 24000.00, 3000.00, 277.96),
(332, '2025-01', '義水段', '0911-0000', 23700.00, 2900.00, 277.96),
(333, '2024-01', '義水段', '0911-0000', 23200.00, 2900.00, 277.96),
(334, '2023-01', '義水段', '0911-0000', 22900.00, 2900.00, 277.96),
(335, '2022-01', '義水段', '0911-0000', 22900.00, 2900.00, 277.96),
(336, '2021-01', '義水段', '0911-0000', 22800.00, 2900.00, 277.96),
(337, '2020-01', '義水段', '0911-0000', 22700.00, 2900.00, 277.96),
(338, '2019-01', '義水段', '0911-0000', 22700.00, 3300.00, 277.96),
(339, '2018-01', '義水段', '0911-0000', 22500.00, 3300.00, 277.96),
(340, '2017-01', '義水段', '0911-0000', 22500.00, 3500.00, 277.96),
(341, '2016-01', '義水段', '0911-0000', 22500.00, 3500.00, 277.96),
(342, '2015-01', '義水段', '0911-0000', 21000.00, 2900.00, 277.96),
(343, '2014-01', '義水段', '0911-0000', 19500.00, 2900.00, 277.96),
(344, '2013-01', '義水段', '0911-0000', 18000.00, 2900.00, 277.96),
(345, '2012-01', '義水段', '0911-0000', 17500.00, 2800.00, 277.96),
(346, '2011-01', '義水段', '0911-0000', 16500.00, 2800.00, 277.96),
(347, '2010-01', '義水段', '0911-0000', 16500.00, 2800.00, 277.96),
(348, '2009-01', '義水段', '0911-0000', 16500.00, 2800.00, 277.96),
(349, '2008-01', '義水段', '0911-0000', 16500.00, 2800.00, 277.96),
(350, '2007-01', '義水段', '0911-0000', 16500.00, 2800.00, 277.96),
(351, '2006-01', '義水段', '0911-0000', 16000.00, 2800.00, 277.96),
(352, '2005-01', '義水段', '0911-0000', 14000.00, 2800.00, 277.96),
(353, '2004-01', '義水段', '0911-0000', 14000.00, 2800.00, 277.96),
(354, '2003-01', '義水段', '0911-0000', 14000.00, 2800.00, 277.96),
(355, '2002-07', '義水段', '0911-0000', 14000.00, 2800.00, NULL),
(356, '2001-07', '義水段', '0911-0000', 14000.00, 2800.00, NULL),
(357, '2000-07', '義水段', '0911-0000', 14000.00, 2800.00, NULL),
(358, '1999-07', '義水段', '0911-0000', 14000.00, 2500.00, NULL),
(359, '1998-07', '義水段', '0911-0000', 14000.00, 2500.00, NULL),
(360, '1997-07', '義水段', '0911-0000', 13000.00, 2500.00, NULL),
(361, '1996-07', '義水段', '0911-0000', 13000.00, NULL, NULL),
(362, '1995-07', '義水段', '0911-0000', 13000.00, NULL, NULL),
(363, '2027-01', '義水段', '0930-0000', 24000.00, 3000.00, 40.73),
(364, '2025-01', '義水段', '0930-0000', 23700.00, 2900.00, 40.73),
(365, '2024-01', '義水段', '0930-0000', 23200.00, 2900.00, 40.73),
(366, '2023-01', '義水段', '0930-0000', 22900.00, 2900.00, 40.73),
(367, '2022-01', '義水段', '0930-0000', 22900.00, 2900.00, 40.73),
(368, '2021-01', '義水段', '0930-0000', 22800.00, 2900.00, 40.73),
(369, '2020-01', '義水段', '0930-0000', 22700.00, 2900.00, 40.73),
(370, '2019-01', '義水段', '0930-0000', 22700.00, 3300.00, 40.73),
(371, '2018-01', '義水段', '0930-0000', 22500.00, 3300.00, 40.73),
(372, '2017-01', '義水段', '0930-0000', 22500.00, 3500.00, 40.73),
(373, '2016-01', '義水段', '0930-0000', 22500.00, 3500.00, 40.73),
(374, '2015-01', '義水段', '0930-0000', 21000.00, 2900.00, 40.73),
(375, '2014-01', '義水段', '0930-0000', 19500.00, 2900.00, 40.73),
(376, '2013-01', '義水段', '0930-0000', 18000.00, 2900.00, 40.73),
(377, '2012-01', '義水段', '0930-0000', 17500.00, 2800.00, 40.73),
(378, '2011-01', '義水段', '0930-0000', 16500.00, 2800.00, 40.73),
(379, '2010-01', '義水段', '0930-0000', 16500.00, 2800.00, 40.73),
(380, '2009-01', '義水段', '0930-0000', 16500.00, 2800.00, 40.73),
(381, '2008-01', '義水段', '0930-0000', 16500.00, 2800.00, 40.73),
(382, '2007-01', '義水段', '0930-0000', 16500.00, 2800.00, 40.73),
(383, '2006-01', '義水段', '0930-0000', 16000.00, 2800.00, 40.73),
(384, '2005-01', '義水段', '0930-0000', 14000.00, 2800.00, 40.73),
(385, '2004-01', '義水段', '0930-0000', 14000.00, 2800.00, 40.73),
(386, '2003-01', '義水段', '0930-0000', 14000.00, 2800.00, 40.73),
(387, '2002-07', '義水段', '0930-0000', 14000.00, 2800.00, NULL),
(388, '2001-07', '義水段', '0930-0000', 14000.00, 2800.00, NULL),
(389, '2000-07', '義水段', '0930-0000', 14000.00, 2800.00, NULL),
(390, '1999-07', '義水段', '0930-0000', 14000.00, 2500.00, NULL),
(391, '1998-07', '義水段', '0930-0000', 14000.00, 2500.00, NULL),
(392, '1997-07', '義水段', '0930-0000', 13000.00, 2500.00, NULL),
(393, '1996-07', '義水段', '0930-0000', 13000.00, NULL, NULL),
(394, '1995-07', '義水段', '0930-0000', 13000.00, NULL, NULL),
(395, '2027-01', '義水段', '0934-0000', 25002.00, 3123.00, 3600.59),
(396, '2025-01', '義水段', '0934-0000', 24702.00, 3023.00, 3600.59),
(397, '2024-01', '義水段', '0934-0000', 24186.00, 3023.00, 3600.59),
(398, '2023-01', '義水段', '0934-0000', 23871.00, 3023.00, 3600.59),
(399, '2022-01', '義水段', '0934-0000', 23871.00, 3023.00, 3600.59),
(400, '2021-01', '義水段', '0934-0000', 23792.00, 3028.00, 3600.59),
(401, '2020-01', '義水段', '0934-0000', 23708.00, 3028.00, 3600.59),
(402, '2019-01', '義水段', '0934-0000', 23708.00, 3444.00, 3600.59),
(403, '2018-01', '義水段', '0934-0000', 23540.00, 3444.00, 3600.59),
(404, '2017-01', '義水段', '0934-0000', 23540.00, 3644.00, 3600.59),
(405, '2016-01', '義水段', '0934-0000', 23540.00, 3644.00, 3600.59),
(406, '2015-01', '義水段', '0934-0000', 22280.00, 3028.00, 3600.59),
(407, '2014-01', '義水段', '0934-0000', 20620.00, 3028.00, 3600.59),
(408, '2013-01', '義水段', '0934-0000', 18320.00, 3028.00, 3600.59),
(409, '2012-01', '義水段', '0934-0000', 17820.00, 2912.00, 3600.59),
(410, '2011-01', '義水段', '0934-0000', 16820.00, 2912.00, 3600.59),
(411, '2010-01', '義水段', '0934-0000', 16740.00, 2912.00, 3600.59),
(412, '2009-01', '義水段', '0934-0000', 16740.00, 2912.00, 3600.59),
(413, '2008-01', '義水段', '0934-0000', 16740.00, 2912.00, 3600.59),
(414, '2007-01', '義水段', '0934-0000', 16740.00, 2912.00, 3600.59),
(415, '2006-01', '義水段', '0934-0000', 16320.00, 2912.00, 3600.59),
(416, '2005-01', '義水段', '0934-0000', 14640.00, 2912.00, 3600.59),
(417, '2004-01', '義水段', '0934-0000', 14640.00, 2912.00, 3600.59),
(418, '2003-01', '義水段', '0934-0000', 14640.00, 2912.00, 3600.59),
(419, '2002-07', '義水段', '0934-0000', 14640.00, 2912.00, NULL),
(420, '2001-07', '義水段', '0934-0000', 14640.00, 2912.00, NULL),
(421, '2000-07', '義水段', '0934-0000', 14640.00, 2912.00, NULL),
(422, '1999-07', '義水段', '0934-0000', 14640.00, 2596.00, NULL),
(423, '1998-07', '義水段', '0934-0000', 14640.00, 2596.00, NULL),
(424, '1997-07', '義水段', '0934-0000', 13000.00, 2596.00, NULL),
(425, '1996-07', '義水段', '0934-0000', 13800.00, NULL, NULL),
(426, '1995-07', '義水段', '0934-0000', 13000.00, NULL, NULL),
(427, '2027-01', '義水段', '0979-0000', 24000.00, 3000.00, 3.33),
(428, '2025-01', '義水段', '0979-0000', 23700.00, 2900.00, 3.33),
(429, '2024-01', '義水段', '0979-0000', 23200.00, 2900.00, 3.33),
(430, '2023-01', '義水段', '0979-0000', 22900.00, 2900.00, 3.33),
(431, '2022-01', '義水段', '0979-0000', 22900.00, 2900.00, 3.33),
(432, '2021-01', '義水段', '0979-0000', 22800.00, 2900.00, 3.33),
(433, '2020-01', '義水段', '0979-0000', 22700.00, 2900.00, 3.33),
(434, '2019-01', '義水段', '0979-0000', 22700.00, 3300.00, 3.33),
(435, '2018-01', '義水段', '0979-0000', 22500.00, 3300.00, 3.33),
(436, '2017-01', '義水段', '0979-0000', 22500.00, 3500.00, 3.33),
(437, '2016-01', '義水段', '0979-0000', 22500.00, 3500.00, 3.33),
(438, '2015-01', '義水段', '0979-0000', 21000.00, 2900.00, 3.33),
(439, '2014-01', '義水段', '0979-0000', 19500.00, 2900.00, 3.33),
(440, '2013-01', '義水段', '0979-0000', 18000.00, 2900.00, 3.33),
(441, '2012-01', '義水段', '0979-0000', 17500.00, 2800.00, 3.33),
(442, '2011-01', '義水段', '0979-0000', 16500.00, 2800.00, 3.33),
(443, '2010-01', '義水段', '0979-0000', 16500.00, 2800.00, 3.33),
(444, '2009-01', '義水段', '0979-0000', 16500.00, 2800.00, 3.33),
(445, '2008-01', '義水段', '0979-0000', 16500.00, 2800.00, 3.33),
(446, '2007-01', '義水段', '0979-0000', 16500.00, 2800.00, 3.33),
(447, '2006-01', '義水段', '0979-0000', 16000.00, 2800.00, 3.33),
(448, '2005-01', '義水段', '0979-0000', 14000.00, 2800.00, 3.33),
(449, '2004-01', '義水段', '0979-0000', 14000.00, 2800.00, 3.33),
(450, '2003-01', '義水段', '0979-0000', 14000.00, 2800.00, 3.33),
(451, '2002-07', '義水段', '0979-0000', 14000.00, 2800.00, NULL),
(452, '2001-07', '義水段', '0979-0000', 14000.00, 2800.00, NULL),
(453, '2000-07', '義水段', '0979-0000', 14000.00, 2800.00, NULL),
(454, '1999-07', '義水段', '0979-0000', 14000.00, 2500.00, NULL),
(455, '1998-07', '義水段', '0979-0000', 14000.00, 2500.00, NULL),
(456, '1997-07', '義水段', '0979-0000', 13000.00, 2500.00, NULL),
(457, '1996-07', '義水段', '0979-0000', 13000.00, NULL, NULL),
(458, '1995-07', '義水段', '0979-0000', 13000.00, NULL, NULL),
(459, '2027-01', '義水段', '0980-0000', 24000.00, 3000.00, 75.70),
(460, '2025-01', '義水段', '0980-0000', 23700.00, 2900.00, 75.70),
(461, '2024-01', '義水段', '0980-0000', 23200.00, 2900.00, 75.70),
(462, '2023-01', '義水段', '0980-0000', 22900.00, 2900.00, 75.70),
(463, '2022-01', '義水段', '0980-0000', 22900.00, 2900.00, 75.70),
(464, '2021-01', '義水段', '0980-0000', 22800.00, 2900.00, 75.70),
(465, '2020-01', '義水段', '0980-0000', 22700.00, 2900.00, 75.70),
(466, '2019-01', '義水段', '0980-0000', 22700.00, 3300.00, 75.70),
(467, '2018-01', '義水段', '0980-0000', 22500.00, 3300.00, 75.70),
(468, '2017-01', '義水段', '0980-0000', 22500.00, 3500.00, 75.70),
(469, '2016-01', '義水段', '0980-0000', 22500.00, 3500.00, 75.70),
(470, '2015-01', '義水段', '0980-0000', 21000.00, 2900.00, 75.70),
(471, '2014-01', '義水段', '0980-0000', 19500.00, 2900.00, 75.70),
(472, '2013-01', '義水段', '0980-0000', 18000.00, 2900.00, 75.70),
(473, '2012-01', '義水段', '0980-0000', 17500.00, 2800.00, 75.70),
(474, '2011-01', '義水段', '0980-0000', 16500.00, 2800.00, 75.70),
(475, '2010-01', '義水段', '0980-0000', 16500.00, 2800.00, 75.70),
(476, '2009-01', '義水段', '0980-0000', 16500.00, 2800.00, 75.70),
(477, '2008-01', '義水段', '0980-0000', 16500.00, 2800.00, 75.70),
(478, '2007-01', '義水段', '0980-0000', 16500.00, 2800.00, 75.70),
(479, '2006-01', '義水段', '0980-0000', 16000.00, 2800.00, 75.70),
(480, '2005-01', '義水段', '0980-0000', 14000.00, 2800.00, 75.70),
(481, '2004-01', '義水段', '0980-0000', 14000.00, 2800.00, 75.70),
(482, '2003-01', '義水段', '0980-0000', 14000.00, 2800.00, 75.70),
(483, '2002-07', '義水段', '0980-0000', 14000.00, 2800.00, NULL),
(484, '2001-07', '義水段', '0980-0000', 14000.00, 2800.00, NULL),
(485, '2000-07', '義水段', '0980-0000', 14000.00, 2800.00, NULL),
(486, '1999-07', '義水段', '0980-0000', 14000.00, 2500.00, NULL),
(487, '1998-07', '義水段', '0980-0000', 14000.00, 2500.00, NULL),
(488, '1997-07', '義水段', '0980-0000', 13000.00, 2500.00, NULL),
(489, '1996-07', '義水段', '0980-0000', 13000.00, NULL, NULL),
(490, '1995-07', '義水段', '0980-0000', 13000.00, NULL, NULL),
(491, '2027-01', '義水段', '0984-0000', 30013.00, 3740.00, 291.97),
(492, '2025-01', '義水段', '0984-0000', 29713.00, 3640.00, 291.97),
(493, '2024-01', '義水段', '0984-0000', 29121.00, 3640.00, 291.97),
(494, '2023-01', '義水段', '0984-0000', 28728.00, 3640.00, 291.97),
(495, '2022-01', '義水段', '0984-0000', 28728.00, 3640.00, 291.97),
(496, '2021-01', '義水段', '0984-0000', 28536.00, 3640.00, 291.97),
(497, '2020-01', '義水段', '0984-0000', 28528.00, 3640.00, 291.97),
(498, '2019-01', '義水段', '0984-0000', 28528.00, 4133.00, 291.97),
(499, '2018-01', '義水段', '0984-0000', 28513.00, 4133.00, 291.97),
(500, '2017-01', '義水段', '0984-0000', 28466.00, 4326.00, 291.97),
(501, '2016-01', '義水段', '0984-0000', 28466.00, 4326.00, 291.97),
(502, '2015-01', '義水段', '0984-0000', 28342.00, 3634.00, 291.97),
(503, '2014-01', '義水段', '0984-0000', 25925.00, 3634.00, 291.97),
(504, '2013-01', '義水段', '0984-0000', 19836.00, 3634.00, 291.97),
(505, '2012-01', '義水段', '0984-0000', 19336.00, 3442.00, 291.97),
(506, '2011-01', '義水段', '0984-0000', 18336.00, 3442.00, 291.97),
(507, '2010-01', '義水段', '0984-0000', 17877.00, 3442.00, 291.97),
(508, '2009-01', '義水段', '0984-0000', 17877.00, 3442.00, 291.97),
(509, '2008-01', '義水段', '0984-0000', 17877.00, 3442.00, 291.97),
(510, '2007-01', '義水段', '0984-0000', 17877.00, 3442.00, 291.97),
(511, '2006-01', '義水段', '0984-0000', 17836.00, 3442.00, 291.97),
(512, '2005-01', '義水段', '0984-0000', 17671.00, 3442.00, 291.97),
(513, '2004-01', '義水段', '0984-0000', 17671.00, 3442.00, 291.97),
(514, '2003-01', '義水段', '0984-0000', 17671.00, 3442.00, 291.97),
(515, '2002-07', '義水段', '0984-0000', 17671.00, 3442.00, NULL),
(516, '2001-07', '義水段', '0984-0000', 17671.00, 3442.00, NULL),
(517, '2000-07', '義水段', '0984-0000', 17671.00, 3442.00, NULL),
(518, '1999-07', '義水段', '0984-0000', 17671.00, 3051.00, NULL),
(519, '1998-07', '義水段', '0984-0000', 17671.00, 3051.00, NULL),
(520, '1997-07', '義水段', '0984-0000', 17589.00, 3051.00, NULL),
(521, '1996-07', '義水段', '0984-0000', 17589.00, NULL, NULL),
(522, '1995-07', '義水段', '0984-0000', 13000.00, NULL, NULL),
(523, '2027-01', '義水段', '0987-0000', 27029.00, 3373.00, 1654.97),
(524, '2025-01', '義水段', '0987-0000', 26729.00, 3273.00, 1654.97),
(525, '2024-01', '義水段', '0987-0000', 26183.00, 3273.00, 1654.97),
(526, '2023-01', '義水段', '0987-0000', 25836.00, 3273.00, 1654.97),
(527, '2022-01', '義水段', '0987-0000', 25836.00, 3273.00, 1654.97),
(528, '2021-01', '義水段', '0987-0000', 25652.00, 3268.00, 1654.97),
(529, '2020-01', '義水段', '0987-0000', 25598.00, 3268.00, 1654.97),
(530, '2019-01', '義水段', '0987-0000', 25598.00, 3714.00, 1654.97),
(531, '2018-01', '義水段', '0987-0000', 25490.00, 3714.00, 1654.97),
(532, '2017-01', '義水段', '0987-0000', 25490.00, 3914.00, 1654.97),
(533, '2016-01', '義水段', '0987-0000', 25490.00, 3914.00, 1654.97),
(534, '2015-01', '義水段', '0987-0000', 24680.00, 3268.00, 1654.97),
(535, '2014-01', '義水段', '0987-0000', 22720.00, 3268.00, 1654.97),
(536, '2013-01', '義水段', '0987-0000', 18920.00, 3268.00, 1654.97),
(537, '2012-01', '義水段', '0987-0000', 18420.00, 3122.00, 1654.97),
(538, '2011-01', '義水段', '0987-0000', 17420.00, 3122.00, 1654.97),
(539, '2010-01', '義水段', '0987-0000', 17190.00, 3122.00, 1654.97),
(540, '2009-01', '義水段', '0987-0000', 17190.00, 3122.00, 1654.97),
(541, '2008-01', '義水段', '0987-0000', 17190.00, 3122.00, 1654.97),
(542, '2007-01', '義水段', '0987-0000', 17190.00, 3122.00, 1654.97),
(543, '2006-01', '義水段', '0987-0000', 16920.00, 3122.00, 1654.97),
(544, '2005-01', '義水段', '0987-0000', 15840.00, 3122.00, 1654.97),
(545, '2004-01', '義水段', '0987-0000', 15840.00, 3122.00, 1654.97),
(546, '2003-01', '義水段', '0987-0000', 15840.00, 3122.00, 1654.97),
(547, '2002-07', '義水段', '0987-0000', 15840.00, 3122.00, NULL),
(548, '2001-07', '義水段', '0987-0000', 15840.00, 3122.00, NULL),
(549, '2000-07', '義水段', '0987-0000', 15840.00, 3122.00, NULL),
(550, '1999-07', '義水段', '0987-0000', 15840.00, 2776.00, NULL),
(551, '1998-07', '義水段', '0987-0000', 15840.00, 2776.00, NULL),
(552, '1997-07', '義水段', '0987-0000', 15300.00, 2776.00, NULL),
(553, '1996-07', '義水段', '0987-0000', 15300.00, NULL, NULL),
(554, '1995-07', '義水段', '0987-0000', 13000.00, NULL, NULL),
(555, '2027-01', '義水段', '0989-0000', 24000.00, 3000.00, 211.57),
(556, '2025-01', '義水段', '0989-0000', 23700.00, 2900.00, 211.57),
(557, '2024-01', '義水段', '0989-0000', 23200.00, 2900.00, 211.57),
(558, '2023-01', '義水段', '0989-0000', 22900.00, 2900.00, 211.57),
(559, '2022-01', '義水段', '0989-0000', 22900.00, 2900.00, 211.57),
(560, '2021-01', '義水段', '0989-0000', 22800.00, 2900.00, 211.57),
(561, '2020-01', '義水段', '0989-0000', 22700.00, 2900.00, 211.57),
(562, '2019-01', '義水段', '0989-0000', 22700.00, 3300.00, 211.57),
(563, '2018-01', '義水段', '0989-0000', 22500.00, 3300.00, 211.57),
(564, '2017-01', '義水段', '0989-0000', 22500.00, 3500.00, 211.57),
(565, '2016-01', '義水段', '0989-0000', 22500.00, 3500.00, 211.57),
(566, '2015-01', '義水段', '0989-0000', 21000.00, 2900.00, 211.57),
(567, '2014-01', '義水段', '0989-0000', 19500.00, 2900.00, 211.57),
(568, '2013-01', '義水段', '0989-0000', 18000.00, 2900.00, 211.57),
(569, '2012-01', '義水段', '0989-0000', 17500.00, 2800.00, 211.57),
(570, '2011-01', '義水段', '0989-0000', 16500.00, 2800.00, 211.57),
(571, '2010-01', '義水段', '0989-0000', 16500.00, 2800.00, 211.57),
(572, '2009-01', '義水段', '0989-0000', 16500.00, 2800.00, 211.57),
(573, '2008-01', '義水段', '0989-0000', 16500.00, 2800.00, 211.57),
(574, '2007-01', '義水段', '0989-0000', 16500.00, 2800.00, 211.57),
(575, '2006-01', '義水段', '0989-0000', 16000.00, 2800.00, 211.57),
(576, '2005-01', '義水段', '0989-0000', 14000.00, 2800.00, 211.57),
(577, '2004-01', '義水段', '0989-0000', 14000.00, 2800.00, 211.57),
(578, '2003-01', '義水段', '0989-0000', 14000.00, 2800.00, 211.57),
(579, '2002-07', '義水段', '0989-0000', 14000.00, 2800.00, NULL),
(580, '2001-07', '義水段', '0989-0000', 14000.00, 2800.00, NULL),
(581, '2000-07', '義水段', '0989-0000', 14000.00, 2800.00, NULL),
(582, '1999-07', '義水段', '0989-0000', 14000.00, 2500.00, NULL),
(583, '1998-07', '義水段', '0989-0000', 14000.00, 2500.00, NULL),
(584, '1997-07', '義水段', '0989-0000', 13000.00, 2500.00, NULL),
(585, '1996-07', '義水段', '0989-0000', 13000.00, NULL, NULL),
(586, '1995-07', '義水段', '0989-0000', 13000.00, NULL, NULL),
(587, '2027-01', '義水段', '0855-0000', 22500.00, 2900.00, 12.73),
(588, '2025-01', '義水段', '0855-0000', 22300.00, 2800.00, 12.73),
(589, '2024-01', '義水段', '0855-0000', 21700.00, 2800.00, 12.73),
(590, '2023-01', '義水段', '0855-0000', 21400.00, 2700.00, 12.73),
(591, '2022-01', '義水段', '0855-0000', 21300.00, 2700.00, 12.73),
(592, '2021-01', '義水段', '0855-0000', 21200.00, 2700.00, 12.73),
(593, '2020-01', '義水段', '0855-0000', 21400.00, 2700.00, 12.73),
(594, '2019-01', '義水段', '0855-0000', 21700.00, 2900.00, 12.73),
(595, '2018-01', '義水段', '0855-0000', 21700.00, 2900.00, 12.73),
(596, '2017-01', '義水段', '0855-0000', 22100.00, 3100.00, 12.73),
(597, '2016-01', '義水段', '0855-0000', 22100.00, 3100.00, 12.73),
(598, '2015-01', '義水段', '0855-0000', 21000.00, 2600.00, 12.73),
(599, '2014-01', '義水段', '0855-0000', 19500.00, 2600.00, 12.73),
(600, '2013-01', '義水段', '0855-0000', 16000.00, 2600.00, 12.73),
(601, '2012-01', '義水段', '0855-0000', 15500.00, 2500.00, 12.73),
(602, '2011-01', '義水段', '0855-0000', 14500.00, 2500.00, 12.73),
(603, '2010-01', '義水段', '0855-0000', 14000.00, 2500.00, 12.73),
(604, '2009-01', '義水段', '0855-0000', 14000.00, 2500.00, 12.73),
(605, '2008-01', '義水段', '0855-0000', 14000.00, 2500.00, 12.73),
(606, '2007-01', '義水段', '0855-0000', 14000.00, 2500.00, 12.73),
(607, '2006-01', '義水段', '0855-0000', 14000.00, 2500.00, 12.73),
(608, '2005-01', '義水段', '0855-0000', 13000.00, 2500.00, 12.73),
(609, '2004-01', '義水段', '0855-0000', 13000.00, 2500.00, 12.73),
(610, '2003-01', '義水段', '0855-0000', 13000.00, 2500.00, 12.73),
(611, '2002-07', '義水段', '0855-0000', 13000.00, 2500.00, NULL),
(612, '2001-07', '義水段', '0855-0000', 13000.00, 2500.00, NULL),
(613, '2000-07', '義水段', '0855-0000', 13000.00, 2500.00, NULL),
(614, '1999-07', '義水段', '0855-0000', 13000.00, 2500.00, NULL),
(615, '1998-07', '義水段', '0855-0000', 13000.00, 2500.00, NULL),
(616, '1997-07', '義水段', '0855-0000', 13000.00, 2500.00, NULL),
(617, '1996-07', '義水段', '0855-0000', 13000.00, NULL, NULL),
(618, '1995-07', '義水段', '0855-0000', 13000.00, NULL, NULL),
(619, '2027-01', '義水段', '0861-0000', 22767.00, 2930.00, 1285.77),
(620, '2025-01', '義水段', '0861-0000', 22564.00, 2830.00, 1285.77),
(621, '2024-01', '義水段', '0861-0000', 21964.00, 2830.00, 1285.77),
(622, '2023-01', '義水段', '0861-0000', 21660.00, 2733.00, 1285.77),
(623, '2022-01', '義水段', '0861-0000', 21564.00, 2733.00, 1285.77),
(624, '2021-01', '義水段', '0861-0000', 21239.00, 2700.00, 1285.77),
(625, '2020-01', '義水段', '0861-0000', 21400.00, 2700.00, 1266.18),
(626, '2019-01', '義水段', '0861-0000', 21700.00, 2900.00, 1266.18),
(627, '2018-01', '義水段', '0861-0000', 21700.00, 2900.00, 1266.18),
(628, '2017-01', '義水段', '0861-0000', 22100.00, 3100.00, 1266.18),
(629, '2016-01', '義水段', '0861-0000', 22100.00, 3100.00, 1266.18),
(630, '2015-01', '義水段', '0861-0000', 21000.00, 2600.00, 1266.18),
(631, '2014-01', '義水段', '0861-0000', 19500.00, 2600.00, 1266.18),
(632, '2013-01', '義水段', '0861-0000', 16000.00, 2600.00, 1266.18),
(633, '2012-01', '義水段', '0861-0000', 15500.00, 2500.00, 1266.18),
(634, '2011-01', '義水段', '0861-0000', 14500.00, 2500.00, 1266.18),
(635, '2010-01', '義水段', '0861-0000', 14000.00, 2500.00, 1266.18),
(636, '2009-01', '義水段', '0861-0000', 14000.00, 2500.00, 1266.18),
(637, '2008-01', '義水段', '0861-0000', 14000.00, 2500.00, 1266.18),
(638, '2007-01', '義水段', '0861-0000', 14000.00, 2500.00, 1266.18),
(639, '2006-01', '義水段', '0861-0000', 14000.00, 2500.00, 1266.18),
(640, '2005-01', '義水段', '0861-0000', 13000.00, 2500.00, 1266.18),
(641, '2004-01', '義水段', '0861-0000', 13000.00, 2500.00, 1266.18),
(642, '2003-01', '義水段', '0861-0000', 13000.00, 2500.00, 1266.18),
(643, '2002-07', '義水段', '0861-0000', 13000.00, 2500.00, NULL),
(644, '2001-07', '義水段', '0861-0000', 13000.00, 2500.00, NULL),
(645, '2000-07', '義水段', '0861-0000', 13000.00, 2500.00, NULL),
(646, '1999-07', '義水段', '0861-0000', 13000.00, 2500.00, NULL),
(647, '1998-07', '義水段', '0861-0000', 13000.00, 2500.00, NULL),
(648, '1997-07', '義水段', '0861-0000', 13000.00, 2500.00, NULL),
(649, '1996-07', '義水段', '0861-0000', 13000.00, NULL, NULL),
(650, '1995-07', '義水段', '0861-0000', 13000.00, NULL, NULL),
(1069, '2026-01', '義水段', '0855-0000', 22767.00, 2930.00, 1285.77),
(1070, '2026-01', '義水段', '0861-0000', 22767.00, 2930.00, 1285.77),
(1071, '2026-01', '義水段', '0911-0000', 22767.00, 2930.00, 1285.77),
(1072, '2026-01', '義水段', '0930-0000', 22767.00, 2930.00, 1285.77),
(1073, '2026-01', '義水段', '0934-0000', 22767.00, 2930.00, 1285.77),
(1074, '2026-01', '義水段', '0979-0000', 22767.00, 2930.00, 1285.77),
(1075, '2026-01', '義水段', '0980-0000', 22767.00, 2930.00, 1285.77),
(1076, '2026-01', '義水段', '0984-0000', 22767.00, 2930.00, 1285.77),
(1077, '2026-01', '義水段', '0987-0000', 22767.00, 2930.00, 1285.77),
(1078, '2026-01', '義水段', '0989-0000', 22767.00, 2930.00, 1285.77),
(1079, '2026-01', '義水段', '0995-0000', 22767.00, 2930.00, 1285.77),
(1080, '2026-01', '義水段', '1035-0000', 22767.00, 2930.00, 1285.77),
(1081, '2026-01', '義水段', '1040-0000', 22767.00, 2930.00, 1285.77),
(1082, '2026-01', '水美東段', '0191-0000', 22767.00, 2930.00, 1285.77),
(1083, '2026-01', '水美東段', '0192-0000', 22767.00, 2930.00, 1285.77),
(1084, '2026-01', '水美東段', '0193-0000', 22767.00, 2930.00, 1285.77),
(1085, '2026-01', '水美東段', '0194-0000', 22767.00, 2930.00, 1285.77),
(1086, '2026-01', '水美東段', '0195-0000', 22767.00, 2930.00, 1285.77),
(1087, '2026-01', '水美東段', '0565-0000', 22767.00, 2930.00, 1285.77);
...
--
-- 資料表索引 `ancestor_worship`
--
ALTER TABLE `ancestor_worship`
...
--
-- 資料表索引 `ethnic_property`
--
ALTER TABLE `ethnic_property`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `land_price`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `unique_record` (`record_date`,`section_name`,`land_number`),
  ADD KEY `idx_section_land` (`section_name`,`land_number`),
...
--
-- 使用資料表自動遞增(AUTO_INCREMENT) `ancestor_worship`
--
ALTER TABLE `ancestor_worship`
  MODIFY `worship_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '報名ID';
...
--
-- 使用資料表自動遞增(AUTO_INCREMENT) `ethnic_property`
--
ALTER TABLE `ethnic_property`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '流水號', AUTO_INCREMENT=31;
...
--
-- 使用資料表自動遞增(AUTO_INCREMENT) `land_price`
--
ALTER TABLE `land_price`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '自動遞增主鍵', AUTO_INCREMENT=1113;
