...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* 🛠️ 已修正：移除萬用字元縮小控制範圍，確保隱藏的語法高亮標籤不會被純白背景蓋過 */
        .jodit-source__textarea, 
        .jodit-src, 
        .jodit-source, 
        .jodit-source__textarea textarea { 
        ...
        /* 專門修復 Ace Code Editor 元件，使其相容白底黑字且能看見程式碼 */
        .jodit-container .ace_editor {
            background-color: #ffffff !important;
        }
        .jodit-container .ace_editor .ace_scroller {
            background-color: #ffffff !important;
        }
        .jodit-container .ace_editor * {
            text-shadow: none !important;
        ...
        .jodit-container .ace_editor .ace_text-layer {
            color: #000000 !important; 
        }
