...
<body>
    ...
    <script class="clanMenuData">
        const clanMenuData = [
            ...
            { id: 23, name: "<span style='font-size:16px;'>4-11.修改族產地價</span>", url: "property_edit.php", parentId: 11 },
            { id: 24, name: "<span style='font-size:16px;'>4-11.查詢族產地價</span>", url: "property_search.php", parentId: 11 },
            { id: 25, name: "<span style='font-size:16px;'>4-11.查詢族產地價稅</span>", url: "property_tax.php", parentId: 11 },
            { id: 26, name: "<span style='font-size:16px;'>4-11.族產查詢與繪圖</span>", url: "property_search_d3.php", parentId: 11 },
            { id: 26, name: "<span style='font-size:16px;'>4-11.族產繪圖AI報告</span>", url: "property_search_d3_ai.php", parentId: 11 }
